...
public class ProtocolosdeServicosAdapter extends TypeAdapter<ProtocolosdeServicos> {

    @Override
    public void write(JsonWriter writer, ProtocolosdeServicos value) throws IOException {
        writer.beginObject();
    ...
    @Override
    public ProtocolosdeServicos read(JsonReader in) throws IOException {
