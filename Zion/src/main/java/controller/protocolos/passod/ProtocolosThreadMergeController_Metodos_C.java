...
public class ProtocolosThreadMergeController_Metodos_C extends ProtocolosThreadMergeController_Metodos_D {
	public void configuraTableViewOrdenacao() {
	...
	public void configuraTableViewAtribuicoes() {
