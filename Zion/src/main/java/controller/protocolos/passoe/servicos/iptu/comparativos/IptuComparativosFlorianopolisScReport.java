...
public class IptuComparativosFlorianopolisScReport {
	public void gerarrelatorioAnalitico(ProtocolosdeServicos pS, List<ProtocolosdeServicos_Detalhe> pSDs) throws JRException {
	...
	public void gerarrelatorioSintetico(ProtocolosdeServicos pS) throws JRException {
		...
		try {
			parametros.put("lb_Ultima_Alteracao_Value",Utilidades.transformaDataEmString(pS.getUltimaAtualizacao(),true));
