...
public class ProtocolosThreadIptuComparativos extends ProtocolosThreadIptuComparativos_Metodos_A
	...
	public void realizandoComparacao() {
		...
		tV_ProtServicos_Detalhe.getItems().clear();
		ProtocoloController_ControlesGerais_A.setAnoAnt(ProtocoloController_ControlesGerais_A.getProtocolosdeServicos().getAnoAnt());
		ProtocoloController_ControlesGerais_A.setAnoAtual(ProtocoloController_ControlesGerais_A.getProtocolosdeServicos().getAnoAtual());
