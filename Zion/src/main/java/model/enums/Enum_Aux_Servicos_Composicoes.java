...
public enum Enum_Aux_Servicos_Composicoes {
	...
	IPTU_COMPARATIVOS_FLORIANOPOLIS_SC(1, 1, 1, "IPTU_COMPARATIVOS_FLORIANOPOLIS_SC",
			...
			Enum_Aux_Servicos_Sub_Classificacoes.COMPARATIVOS, Enum_Aux_Servicos_Restricoes.FLORIANOPOLIS_SC,false,"protocolos_passoeservicosiptucomparativos.fxml","Iniciando Comparações"),
	...
	IPTU_CONFERENCIA_DEBITOS_FLORIANOPOLIS_SC(4, 1, 4, "IPTU_CONFERENCIA_DEBITOS_FLORIANOPOLIS_SC",
			...
			Enum_Aux_Servicos_Sub_Classificacoes.CONFERENCIA_DEBITOS, Enum_Aux_Servicos_Restricoes.FLORIANOPOLIS_SC,true,"protocolos_passoeservicosiptuconferenciadebitos.fxml","Iniciando Conferencia de Débitos"),
	...
	IPTU_COMPARATIVOS_SAO_JOSE_SC(5, 1, 1, "IPTU_COMPARATIVOS_SAO_JOSE_SC", "COMPARAÇÕES DE IPTU  - SÃO JOSÉ - SC ",
			...
			Enum_Aux_Servicos_Restricoes.SAO_JOSE_SC,false,"protocolos_passoeservicosiptucomparativos.fxml","Iniciando Comparações"),
	// utilizar Object instanciar_Classe(String classe)
	...
	IPTU_CONFERENCIA_DEBITOS_SAO_JOSE_SC(8, 1, 4, "IPTU_CONFERÊNCIA_DEBITOS_SAO_JOSE_SC",
			...
			Enum_Aux_Servicos_Sub_Classificacoes.CONFERENCIA_DEBITOS, Enum_Aux_Servicos_Restricoes.SAO_JOSE_SC,true,"protocolos_passoeservicosiptuconferenciadebitos.fxml","Iniciando Conferencia de Débitos"),
	// utilizar Object instanciar_Classe(String classe)

	IPTU_COMPARATIVOS_BIGUACU_SC(9, 1, 1, "IPTU_COMPARATIVOS_BIGUACU_SC", "COMPARAÇÕES DE IPTU  - BIGUAÇU - SC ",
			Enum_Aux_Servicos_Classificacoes.IPTU, Enum_Aux_Servicos_Sub_Classificacoes.COMPARATIVOS,
			Enum_Aux_Servicos_Restricoes.BIGUACU_SC,false,"protocolos_passoeservicosiptucomparativos.fxml","Iniciando Comparações"),
	// utilizar Object instanciar_Classe(String classe)
	...
	IPTU_CONFERENCIA_DEBITOS_BIGUACU_SC(12, 1, 4, "IPTU_CONFERÊNCIA_DEBITOS_BIGUACU_SC",
			...
			Enum_Aux_Servicos_Sub_Classificacoes.CONFERENCIA_DEBITOS, Enum_Aux_Servicos_Restricoes.BIGUACU_SC,true,"protocolos_passoeservicosiptuconferenciadebitos.fxml","Iniciando Conferencia de Débitos"),
	// utilizar Object instanciar_Classe(String classe)

	IPTU_COMPARATIVOS_PALHOCA_SC(13, 1, 1, "IPTU_COMPARATIVOS_PALHOCA_SC", "COMPARAÇÕES DE IPTU  - PALHOÇA - SC ",
			Enum_Aux_Servicos_Classificacoes.IPTU, Enum_Aux_Servicos_Sub_Classificacoes.COMPARATIVOS,
			Enum_Aux_Servicos_Restricoes.PALHOCA_SC,false,"protocolos_passoeservicosiptucomparativos.fxml","Iniciando Comparações"),
	// utilizar Object instanciar_Classe(String classe)
	...
	IPTU_CONFERENCIA_DEBITOS_PALHOCA_SC(16, 1, 4, "IPTU_CONFERÊNCIA_DEBITOS_PALHOCA_SC",
			...
			Enum_Aux_Servicos_Sub_Classificacoes.CONFERENCIA_DEBITOS, Enum_Aux_Servicos_Restricoes.PALHOCA_SC,true,"protocolos_passoeservicosiptuconferenciadebitos.fxml","Iniciando Conferencia de Débitos"),
	// utilizar Object instanciar_Classe(String classe)
	AGUA_COMPARATIVOS_SANTA_CATARINA_SC(17, 2, 1, "AGUA_COMPARATIVOS_SANTA_CATARINA_SC",
			...
			Enum_Aux_Servicos_Sub_Classificacoes.COMPARATIVOS, Enum_Aux_Servicos_Restricoes.SANTA_CATARINA_SC,false,"protocolos_passoeservicosiptucomparativos.fxml","Iniciando Comparações"),
	// utilizar Object instanciar_Classe(String classe)
	...
	AGUA_CONFERENCIA_DEBITOS_SANTA_CATARINA_SC(20, 2, 4, "AGUA_CONFERENCIA_DEBITOS_SANTA_CATARINA_SC",
			...
			Enum_Aux_Servicos_Sub_Classificacoes.CONFERENCIA_DEBITOS, Enum_Aux_Servicos_Restricoes.SANTA_CATARINA_SC,true,"protocolos_passoeservicosiptuconferenciadebitos.fxml","Iniciando Conferencia de Débitos"),
	// utilizar Object instanciar_Classe(String classe)
	...
	private Enum_Aux_Servicos_Composicoes(int id, int contagem_de_tipos, int contagem_de_qtde_tipos, String descricao,
			...
			Enum_Aux_Servicos_Sub_Classificacoes sub_Classificacao, Enum_Aux_Servicos_Restricoes restricao,boolean anoEMes,String formulario,String titulo) {
		this.id = id;
